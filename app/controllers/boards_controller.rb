class BoardsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @province.update(board_params)
        format.html { redirect_to @board, notice: 'Province was successfully updated.' }
  ...
  private
    ...
    def board_params
      params(:board).permit([:id,:name,:description,:length,:width])
    end
end
